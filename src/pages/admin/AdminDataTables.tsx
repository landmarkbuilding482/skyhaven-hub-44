...
const AdminDataTables = () => {
  ...
  // New state for Paid Parking data
  ...
  // New dialog state for Paid Parking
  ...
  // New editing state for Paid Parking
  ...
  // New form state for Paid Parking
  ...
  const tables = [
    ...
    // New table entry for Paid Parking
  ...
  const handlePaidParkingSubmit = async () => {
    ...
    if (editingPaidParking) {
      // Update existing paid parking record
      const { error } = await supabase
        .from('paid_parking')
        .update(formData)
      ...
      // Create new paid parking record
      const { error } = await supabase
        .from('paid_parking')
        .insert([formData]);
  ...
  const renderTable = () => {
    ...
    // New table rendering for Paid Parking
    if (selectedTable === 'paidParking') {
      ...
      return (
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold">Paid Parking Table</h3>
            <Dialog open={isPaidParkingDialogOpen} onOpenChange={setIsPaidParkingDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {editingPaidParking ? 'Update the paid parking record' : 'Add a new paid parking record to the table'}
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    <Label htmlFor="numberOfVehicles" className="text-right">Number of Vehicles</Label>
                    <Input id="numberOfVehicles" type="number" value={paidParkingForm.number_of_vehicles} onChange={(e) => setPaidParkingForm({ ...paidParkingForm, number_of_vehicles: parseInt(e.target.value) || 0 })} className="col-span-3" />
                  </div>
                  <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Table>
            ...
            <TableBody>
              {filteredPaidParkingData.map((record) => (
                <TableRow key={record.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => handlePaidParkingDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex space-x-2">
              <Dialog open={isMaintenanceDialogOpen} onOpenChange={setIsMaintenanceDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingMaintenance ? 'Edit Maintenance Record' : 'Add New Maintenance Record'}</DialogTitle>
                    <DialogDescription>
                      {editingMaintenance ? 'Update the details for this maintenance record.' : 'Fill in the details for a new maintenance record.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Table>
            ...
            <TableBody>
              {filteredMaintenanceData.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="font-medium">{record.id}</TableCell>
                  <TableCell>{record.date_reported}</TableCell>
                  <TableCell>{record.floor}</TableCell>
                  <TableCell>{record.issue_reporter}</TableCell>
                  <TableCell>{record.issue_type}</TableCell>
                  <TableCell>{record.material_affected}</TableCell>
                  <TableCell>{record.description}</TableCell>
                  <TableCell>{record.assigned_vendor}</TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleMaintenanceEdit(record)}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleMaintenanceDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
    ...
    // Handle utilities table with real backend
    if (selectedTable === 'utilities') {
      const filteredUtilitiesData = utilitiesData.filter((item) =>
        Object.values(item).some(value =>
          value?.toString().toLowerCase().includes(searchTerm.toLowerCase())
        )
      );
      return (
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex space-x-2">
              <Dialog open={isUtilitiesDialogOpen} onOpenChange={setIsUtilitiesDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingUtility ? 'Edit Utility Record' : 'Add New Utility Record'}</DialogTitle>
                    <DialogDescription>
                      {editingUtility ? 'Update the details for this utility record.' : 'Fill in the details for a new utility record.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
          ...
          <Table>
            ...
            <TableBody>
              {filteredUtilitiesData.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="font-medium">{record.id}</TableCell>
                  <TableCell>{record.date}</TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleUtilitiesEdit(record)}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleUtilitiesDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
    ...
    // Handle feedback & complaints table with real backend
      ...
      return (
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex space-x-2">
              <Dialog open={isFeedbackDialogOpen} onOpenChange={setIsFeedbackDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingFeedback ? 'Edit Feedback Record' : 'Add New Feedback Record'}</DialogTitle>
                    <DialogDescription>
                      {editingFeedback ? 'Update the details for this feedback record.' : 'Fill in the details for a new feedback record.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Select
                        value={feedbackForm.tenant_id}
                        onValueChange={(value) => setFeedbackForm({ ...feedbackForm, tenant_id: value })}
                      >
                        <SelectTrigger className="col-span-3">
          ...
          <Table>
            ...
            <TableBody>
              {filteredFeedbackData.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="font-medium">{record.id}</TableCell>
                  <TableCell>{record.date}</TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleFeedbackEdit(record)}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleFeedbackView(record)}>
                        <Eye className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleFeedbackDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
          ...
          <Dialog open={isFeedbackViewDialogOpen} onOpenChange={setIsFeedbackViewDialogOpen}>
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Viewing full details of the selected record.
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">ID:</Label>
                  <span className="col-span-3">{viewingFeedback?.id}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3">{viewingFeedback?.tenant_name}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3 break-words">{viewingFeedback?.description}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3">{viewingFeedback?.assigned_to}</span>
                </div>
              </div>
            </DialogContent>
          </Dialog>
    ...
    // Handle revenue & expenses table with real backend
    if (selectedTable === 'revenue') {
      const filteredRevenueExpenseData = revenueExpenseData.filter((item) =>
        Object.values(item).some(value =>
          value?.toString().toLowerCase().includes(searchTerm.toLowerCase())
        )
      );
      return (
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex space-x-2">
              <Dialog open={isRevenueExpenseDialogOpen} onOpenChange={setIsRevenueExpenseDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingRevenueExpense ? 'Edit Revenue/Expense Record' : 'Add New Revenue/Expense Record'}</DialogTitle>
                    <DialogDescription>
                      {editingRevenueExpense ? 'Update the details for this revenue or expense record.' : 'Fill in the details for a new revenue or expense record.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="category" className="text-right">Category</Label>
                      <Select
                        value={revenueExpenseForm.category}
                        onValueChange={(value) => setRevenueExpenseForm({ ...revenueExpenseForm, category: value })}
                        disabled={!revenueExpenseForm.type}
                      >
                        <SelectTrigger className="col-span-3">
                          <SelectValue placeholder="Select category" />
                        </SelectTrigger>
                        <SelectContent>
                          {revenueExpenseForm.type === "Revenue"
                            ? revenueExpenseDropdownOptions.revenueCategories.map((option) => (
                              <SelectItem key={option} value={option}>{option}</SelectItem>
                            ))
                            : revenueExpenseForm.type === "Expense"
                              ? revenueExpenseDropdownOptions.expenseCategories.map((option) => (
                                <SelectItem key={option} value={option}>{option}</SelectItem>
                              ))
                              : null}
                        </SelectContent>
          ...
          <Table>
            ...
            <TableBody>
              {filteredRevenueExpenseData.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="font-medium">{record.id}</TableCell>
                  <TableCell>{record.date}</TableCell>
                  <TableCell>
                    <Badge variant="outline" className={record.type === 'Revenue' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                      {record.type}
                    </Badge>
                  </TableCell>
                  <TableCell>{record.category}</TableCell>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleRevenueExpenseEdit(record)}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleRevenueExpenseView(record)}>
                        <Eye className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleRevenueExpenseDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
          ...
          <Dialog open={isRevenueExpenseViewDialogOpen} onOpenChange={setIsRevenueExpenseViewDialogOpen}>
            <DialogContent className="sm:max-w-[425px]">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">ID:</Label>
                  <span className="col-span-3">{viewingRevenueExpense?.id}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">Date:</Label>
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">Type:</Label>
                  <span className="col-span-3">
                    <Badge variant="outline" className={viewingRevenueExpense?.type === 'Revenue' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">Description:</Label>
                  <span className="col-span-3 break-words">{viewingRevenueExpense?.description}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">Amount:</Label>
                  <span className="col-span-3">${viewingRevenueExpense?.amount}</span>
                </div>
              </div>
            </DialogContent>
          </Dialog>
    ...
    // Handle asset inventory table with real backend
    if (selectedTable === 'assets') {
      const filteredAssetInventoryData = assetInventoryData.filter((item) =>
        Object.values(item).some(value =>
          value?.toString().toLowerCase().includes(searchTerm.toLowerCase())
        )
      );
      return (
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex space-x-2">
              <Dialog open={isAssetInventoryDialogOpen} onOpenChange={setIsAssetInventoryDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>{editingAssetInventory ? 'Edit Asset Record' : 'Add New Asset Record'}</DialogTitle>
                    <DialogDescription>
                      {editingAssetInventory ? 'Update the details for this asset record.' : 'Fill in the details for a new asset record.'}
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <Input
                        ...
                        onChange={(e) => setAssetInventoryForm({ ...assetInventoryForm, value: parseFloat(e.target.value) || 0 })}
                        className="col-span-3"
                      />
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="warranty_month" className="text-right">Warranty (Month)</Label>
                      <Input
                        id="warranty_month"
                        type="number"
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      <Label htmlFor="warranty_year" className="text-right">Warranty (Year)</Label>
                      <Input
                        id="warranty_year"
                        type="number"
          ...
          <Table>
            ...
            <TableBody>
              {filteredAssetInventoryData.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="font-medium">{record.id}</TableCell>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={getStatusColor(record.condition)}>
                      {record.condition}
                    </Badge>
                  </TableCell>
                  <TableCell>{record.last_maintenance}</TableCell>
                  <TableCell>{record.next_maintenance}</TableCell>
                  <TableCell>{record.warranty_year ? `${record.warranty_month}/${record.warranty_year}` : 'N/A'}</TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm" onClick={() => handleAssetInventoryEdit(record)}>
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleAssetInventoryView(record)}>
                        <Eye className="h-4 w-4" />
                      </Button>
                      <Button variant="outline" size="sm" onClick={() => handleAssetInventoryDelete(record.id)}>
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </div>
                  </TableCell>
          ...
          <Dialog open={isAssetInventoryViewDialogOpen} onOpenChange={setIsAssetInventoryViewDialogOpen}>
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Viewing full details of the selected asset.
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label className="text-right font-semibold">ID:</Label>
                  <span className="col-span-3">{viewingAssetInventory?.id}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3">${viewingAssetInventory?.value}</span>
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <span className="col-span-3">{viewingAssetInventory?.warranty_year ? `${viewingAssetInventory?.warranty_month}/${viewingAssetInventory?.warranty_year}` : 'N/A'}</span>
                </div>
              </div>
            </DialogContent>
          </Dialog>
        ...
        <TableHeader>
          <TableRow>
            {Object.keys(data[0]).map((key) => (
              <TableHead key={key}>{key.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase())}</TableHead>
            ))}
            <TableHead>Actions</TableHead>
          </TableRow>
        </TableHeader>
    ...
    <div className="p-4 md:p-6 lg:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage and view building data from various sources.
          </CardDescription>
        </CardHeader>
        <CardContent>
