...
SELECT 
    ...
    EXTRACT(YEAR FROM AGE(CURRENT_DATE, t.registration_date)) * 12 + 
    EXTRACT(MONTH FROM AGE(CURRENT_DATE, t.registration_date)) AS occupancy_months,
    ...
    CASE 
        WHEN t.first_payment_date IS NOT NULL THEN
            ...
            CEIL(EXTRACT(EPOCH FROM (CURRENT_DATE - t.first_payment_date)) / (30 * 24 * 60 * 60))
        ELSE NULL
